...
package me.sivieri.dimatodos.noteendpoint;
...
public class Noteendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetNote extends NoteendpointRequest<me.sivieri.dimatodos.noteendpoint.model.Note> {
    ...
    protected GetNote(java.lang.Long id) {
      super(Noteendpoint.this, "GET", REST_PATH, null, me.sivieri.dimatodos.noteendpoint.model.Note.class);
   ...
   *
   * @param content the {@link me.sivieri.dimatodos.noteendpoint.model.Note}
   * @return the request
   */
  public InsertNote insertNote(me.sivieri.dimatodos.noteendpoint.model.Note content) throws java.io.IOException {
    InsertNote result = new InsertNote(content);
    initialize(result);
    return result;
  }

  public class InsertNote extends NoteendpointRequest<me.sivieri.dimatodos.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected InsertNote(me.sivieri.dimatodos.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "POST", REST_PATH, content, me.sivieri.dimatodos.noteendpoint.model.Note.class);
    }
  ...
  public class ListNote extends NoteendpointRequest<me.sivieri.dimatodos.noteendpoint.model.CollectionResponseNote> {
     ...
     */
    protected ListNote() {
      super(Noteendpoint.this, "GET", REST_PATH, null, me.sivieri.dimatodos.noteendpoint.model.CollectionResponseNote.class);
    }
   ...
   * @return the request
   */
  public RemoveNote removeNote(java.lang.Long id) throws java.io.IOException {
  ...
  public class RemoveNote extends NoteendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveNote(java.lang.Long id) {
    ...
    public RemoveNote setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public UpdateNote updateNote(me.sivieri.dimatodos.noteendpoint.model.Note content) throws java.io.IOException {
    UpdateNote result = new UpdateNote(content);
    initialize(result);
    return result;
  }

  public class UpdateNote extends NoteendpointRequest<me.sivieri.dimatodos.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected UpdateNote(me.sivieri.dimatodos.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "PUT", REST_PATH, content, me.sivieri.dimatodos.noteendpoint.model.Note.class);
    }
